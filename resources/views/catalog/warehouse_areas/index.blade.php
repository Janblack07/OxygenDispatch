<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-lg text-gray-800 leading-tight">{{ __('Áreas') }}</h2>
                <p class="mt-0.5 text-xs text-gray-500">Catálogo de áreas de bodega.</p>
            </div>

            <a href="{{ route('warehouse-areas.create') }}"
