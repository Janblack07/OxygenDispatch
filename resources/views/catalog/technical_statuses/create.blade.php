        ...
        <div class="catalog-form-header">
            <div>
                ...
                <p class="catalog-form-page-subtitle">
                    Registra un nuevo estado para la clasificación técnica de tanques.
                </p>
            </div>
            ...
            <section class="catalog-form-card">
                <div class="catalog-form-card-header">
                    <h3 class="catalog-form-card-title">
                        Información del estado técnico
                    </h3>

                    <p class="catalog-form-card-subtitle">
                        El nombre será utilizado para clasificar los tanques durante la revisión.
                    </p>
                </div>
                ...
                <div class="catalog-form-card-body">
                    <form
                        method="POST"
                        action="{{ route('technical-statuses.store') }}"
                    >
                        @csrf
