<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                <h2 class="font-semibold text-lg text-gray-800 leading-tight">{{ __('Estados técnicos') }}</h2>
                <p class="mt-0.5 text-xs text-gray-500">Catálogo de estados técnicos.</p>
            </div>

            <a href="{{ route('technical-statuses.create') }}"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="divide-y">
                                ...
                                @empty
                                    <tr><td colspan="2" class="px-3 py-6 text-center text-gray-500">Sin registros.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
