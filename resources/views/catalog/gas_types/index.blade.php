    ...
    <x-slot name="header">
        <div class="flex items-start justify-between gap-4">
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500">Catálogo de tipos de gas.</p>
            </div>

            <a href="{{ route('gas-types.create') }}"
